...
TEST(svutGTest,assert_throw)
{
	...
	SVUT_ASSERT_THROW_SOMETHING(ASSERT_THROW(abs(5),int));
	SVUT_ASSERT_THROW_SOMETHING(EXPECT_THROW(abs(5),int));
}
...
TEST(svutGTest,assert_any_throw)
{
	...
	SVUT_ASSERT_THROW_SOMETHING(ASSERT_ANY_THROW(abs(5)));
	SVUT_ASSERT_THROW_SOMETHING(EXPECT_ANY_THROW(abs(5)));
}

/*******************  FUNCTION  *********************/
TEST(svutGTest,assert_no_throw)
{
	ASSERT_NO_THROW(abs(10));
	EXPECT_NO_THROW(abs(10));
