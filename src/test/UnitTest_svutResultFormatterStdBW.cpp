...
class UnitTest_svutResultFormatterStdBW : public TestCase
{
	...
	CPPUNIT_TEST(testCloseTestMethod_8);
	CPPUNIT_TEST(testCloseTestMethod_9);
	CPPUNIT_TEST(testCloseTestMethod_10);
	CPPUNIT_TEST(testCloseTestMethod_11);
	...
	public:
		...
		void testCloseTestMethod_8(void);
		void testCloseTestMethod_9(void);
		void testCloseTestMethod_10(void);
		void testCloseTestMethod_11(void);
...
/********************  METHODE  *********************/
void UnitTest_svutResultFormatterStdBW::testCloseTestMethod_8(void )
{
	UnitTestMockTestCase testCase;
	svutTestMethod meth("testMethod",NULL,SVUT_NO_LOCATION);
...
/********************  METHODE  *********************/
void UnitTest_svutResultFormatterStdBW::testCloseTestMethod_9(void )
{
	UnitTestMockTestCase testCase;
	svutTestMethod meth("testMethod",NULL,SVUT_NO_LOCATION);
...
/********************  METHODE  *********************/
void UnitTest_svutResultFormatterStdBW::testCloseTestMethod_10(void )
{
	UnitTestMockTestCase testCase;
	svutTestMethod meth("testMethod",NULL,SVUT_NO_LOCATION);
	svutCodeLocation location("file.cpp","methode",33);
...
/********************  METHODE  *********************/
void UnitTest_svutResultFormatterStdBW::testCloseTestMethod_11(void )
{
	UnitTestMockTestCase testCase;
	svutTestMethod meth("testMethod",NULL,SVUT_NO_LOCATION);
	svutCodeLocation location("file.cpp","methode",33);
