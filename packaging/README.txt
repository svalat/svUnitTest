...
First create a directory in your home dir, place the project archive in it and rename it to svUnitTest_0.3.0-dev.orig.tar.gz.
...
--------------------------------------------------------------------
$user> git archive --prefix=svUnitTest-0.3.0-dev/ v0.3.0-dev | gzip > YOUR_LOCATION/svUnitTest_0.3.0-dev.orig.tar.gz
--------------------------------------------------------------------

Go to your directory and extract svUnitTest_0.3.0-dev.orig.tar.gz with and go in the directory.

--------------------------------------------------------------------
$user> tar -xvzf svUnitTest_0.3.0-dev.orig.tar.gz
$user> cd svUnitTest_0.3.0-dev
--------------------------------------------------------------------
